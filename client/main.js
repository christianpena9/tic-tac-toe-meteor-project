...
$(document).ready(function() {
	...
	// VARIABLES
	const human = 'x'; // turn = 0
	const computer = 'o'; // turn = 1
	var compMove;
	let turn = 0; // toggles btw 0 and 1 for switching turns

	var boardCheck; // function to check value in each cell
	let a1; // value within each cell
	let a2;
	let a3;
	let b1;
	let b2;
	...
	let xWin = false; // true if X wins 
	let oWin = false; // true if O wins 
